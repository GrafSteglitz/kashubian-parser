This is the README file for the kashubian-parser project written in Python 3.
...
The first configuration runs on the first chapter of the Kashubian translation of Anne of Green Gable.
